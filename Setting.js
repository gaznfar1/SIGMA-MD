...
global.owner = process.env.OWNER_NUMBER  || '923126146718' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "923126146718" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '21_05_2024_SIGMA_MD_SqHbRfhB_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
